...
export default function StaffUsers() {
    ...
    const [createData, setCreateData] = React.useState({
        ...
        email: '',
        password: '',
        role: 'user' // Default and only option for staff
    });
    ...
    const handleApprove = async (userId) => {
        try {
            setError('');
            await api.post(`/staff/users/${userId}/approve/`);
    ...
    const handleReject = async (userId) => {
        try {
            setError('');
            await api.post(`/staff/users/${userId}/reject/`);
    ...
    const handleCreateSubmit = async () => {
        ...
        try {
            ...
            setError('');
            await api.post('/staff/users/create/', createData);
    ...
    return (
        <Box>
            <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
                <Typography variant="h6">User Management (Staff)</Typography>
