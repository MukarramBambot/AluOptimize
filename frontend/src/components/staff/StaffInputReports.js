...
export default function StaffInputReports() {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                const response = await api.get('/staff/input-reports/users/');
        ...
        if (selectedUser) {
            const fetchUserInputs = async () => {
                try {
                    ...
                    const response = await api.get(`/staff/input-reports/${selectedUser.id}/inputs/`);
    ...
    const handleGenerateReport = async (emailToUser = false, download = false) => {
        ...
        try {
            ...
            if (download) {
                // Download PDF
                const response = await api.post('/staff/input-reports/generate/', requestData, {
                    responseType: 'blob'
                });
