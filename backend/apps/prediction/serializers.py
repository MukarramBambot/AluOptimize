...
class ProductionInputSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'alumina_concentration', 'submitted_by', 'submitted_by_username', 'submitted_by_email',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'submitted_by', 'submitted_by_username', 'submitted_by_email', 'created_at', 'updated_at']
        extra_kwargs = {
